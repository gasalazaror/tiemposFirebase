...
var NgSelectComponent = /** @class */ (function () {
    ...
    NgSelectComponent.prototype._setItemsFromNgOptions = function () {
        ...
        var handleOptionChange = function () {
            ...
            rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"].apply(void 0, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(_this.ngOptions.map(function (option) { return option.stateChange$; }))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(changedOrDestroyed))
...
var ConsultarVehiculoComponent = /** @class */ (function () {
    ...
    ConsultarVehiculoComponent.prototype.eliminarVehiculo = function (vehiculo) {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default()({
            ...
            if (result.value) {
                _this.vehiculoService.eliminarVehiculo(vehiculo.id).then(function (res) {
...
var CrearVehiculoComponent = /** @class */ (function () {
    ...
    CrearVehiculoComponent.prototype.guardarVehiculo = function () {
        ...
        if (this.vehiculoForm.value.placa == '') {
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()('Existió un error', 'ID/Placa es requerido', 'error');
        }
        else if (this.vehiculoForm.value.marca == '') {
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()('Existió un error', 'La marca es requerida', 'error');
        }
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()('Existió un error', 'El dueño es requerido', 'error');
        }
        else {
            if (this.id == 'nuevo' || this.id == null) {
                ...
                this.vehiculoService.modificarVehiculo(this.id, this.vehiculoForm.value).then(function (res) {
                    ...
                    sweetalert2__WEBPACK_IMPORTED_MODULE_6___default()('Existió un error', 'Existió un error al guardar el vehículo', 'error');
                });
            }
        }
    };
