...
var CrearVehiculoComponent = /** @class */ (function () {
    function CrearVehiculoComponent(fb, personaService, vehiculoService) {
        this.fb = fb;
    ...
    CrearVehiculoComponent.prototype.guardarVehiculo = function () {
        ...
        this.vehiculoService.crearVehiculo(this.vehiculoForm.value.dueno.id, this.vehiculoForm.value).then(function (vehiculo) { _this.vehiculoForm.reset(); }, function (error) { console.log(error); });
    };
...
var VehiculoService = /** @class */ (function () {
    ...
    VehiculoService.prototype.crearVehiculo = function (persona, vehiculo) {
