...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, afAuth, db) {
        this.router = router;
        this.afAuth = afAuth;
        this.db = db;
    ...
    LoginComponent.prototype.onLoggedin2 = function () {
        ...
        this.afAuth.auth.signInWithEmailAndPassword(this.usuario.email, this.usuario.password)
            ...
            if (usuario.user.emailVerified) {
                _this.error = '';
                _this.itemDoc = _this.db.doc('usuario/' + _this.afAuth.auth.currentUser.uid);
                _this.empresas = _this.db.collection('empresaUsuario', function (query) { return query.where('correo', '==', _this.usuario.email).where('tipo', '==', 'usuario'); }).valueChanges();
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], angularfire2_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], angularfire2_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"]])
    ], LoginComponent);
