...
/* harmony import */ var _pipes_anadir_ceros_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../pipes/anadir-ceros.pipe */ "./src/app/pipes/anadir-ceros.pipe.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReporteComponent = /** @class */ (function () {
    function ReporteComponent(ordenService, personaService, servicioService) {
        ...
        this.operadores = [];
        this.tareas = [];
        this.estadisticas = { te: 0, tr: 0, fin: 0, tefin: 0, eficiencia: 0 };
        this.orden = [];
        this.pieChartLabels = [
            'Cita/Recepción',
            'En Producción',
        ...
        this.pieChartLabelsEficiencia = [
            'Muy buena',
            'Buena',
            'Regular',
        ];
        this.pieChartDataEficiencia = [0, 0, 0];
    ...
    ReporteComponent.prototype.randomize = function () {
    };
    ...
    ReporteComponent.prototype.buscarPorOrden = function () {
        if (this.ordenSeleccionada != '') {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_7___default()('Existió un error', 'Seleccione una Orden de Trabajo para continuar', 'error');
        }
    };
    ReporteComponent.prototype.buscarOrdenes = function () {
        var _this = this;
        ...
        this.ordenService.obtenerOrdenesFecha(fechiInicio, fechaFin)
            ...
            var espera = 0;
            var pausa = 0;
            _this.estadisticas.te = 0;
            _this.estadisticas.tr = 0;
            _this.estadisticas.fin = 0;
            _this.estadisticas.tefin = 0;
            _this.estadisticas.eficiencia = 100;
            ordenes.forEach(function (orden) {
                orden.data.numero = 'OT-' + new _pipes_anadir_ceros_pipe__WEBPACK_IMPORTED_MODULE_8__["AnadirCerosPipe"]().transform(orden.data.numero, 5);
                _this.ordenes.push(orden);
                if (_this.ordenSeleccionada && _this.ordenSeleccionada != "") {
                    if (orden.id == _this.ordenSeleccionada) {
                        orden.data.servicios.forEach(function (servicio) {
                            _this.operadores.push(servicio.operador);
                            if (_this.operadorSeleccionado && _this.operadorSeleccionado != "") {
                                if (_this.operadorSeleccionado == servicio.operador.id) {
                                    _this.estadisticas.te += servicio.tiempoEstandar * servicio.cantidad * 60;
                                    if (servicio.estadisticas) {
                                        porfacturar++;
                                        _this.estadisticas.fin++;
                                        _this.estadisticas.tr += servicio.estadisticas.tiempoReal;
                                        _this.estadisticas.tefin += servicio.estadisticas.tiempoEstandar;
                                    }
            ...
            if (_this.estadisticas.tefin == 0 || _this.estadisticas.tr == 0) {
                _this.estadisticas.eficiencia = 100;
            }
            else {
                _this.estadisticas.eficiencia = ((_this.estadisticas.tefin / _this.estadisticas.tr) * 100).toFixed(2);
            }
            $('#reporte').DataTable().destroy();
            _this.dtTrigger.next();
            _this.operadores = _this.eliminarObjetosDuplicados(_this.operadores, "id");
        });
    };
    ReporteComponent.prototype.chartClicked = function (e) {
    };
    ReporteComponent.prototype.buscarTareasPorOrden = function (idOrden) {
        ...
        this.ordenService.obtenerUnaOrden(idOrden)
            ...
            var finalizadas = 0;
            res.servicios.forEach(function (servicio) {
    ...
    ReporteComponent.prototype.eliminarObjetosDuplicados = function (arr, prop) {
        var nuevoArray = [];
        var lookup = {};
        for (var i in arr) {
    ...
    ], ReporteComponent.prototype, "dtElement", void 0);
    ReporteComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_servicios_orden_orden_service__WEBPACK_IMPORTED_MODULE_2__["OrdenService"], _servicios_persona_service__WEBPACK_IMPORTED_MODULE_5__["PersonaService"], _servicios_servicio_servicio_service__WEBPACK_IMPORTED_MODULE_6__["ServicioService"]])
    ], ReporteComponent);
